...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      // watching express
      express: {
        files: ['server.js', 'view/**/*.jade'],
        tasks: ['express:local', 'open:server'],
        options: {
          spawn: false
        }
      }
    ...
    // open path with default browser
    open: {
      server: {
    ...
    //   dist: {
    //     files: {
    //       '<%= yeoman.dist %>/modules/modules.js': [
    //         '<%= yeoman.dist %>/modules/modules.js'
    //       ]
    //     }
    //   }
  ...
  grunt.registerTask('exp', ['express', 'open:server', 'watch:express']);
};
